            ...
            <div className="card-body">
                ...
                <div className="flex space-x-6">
                    <div className="flex gap-2">
                        <button onClick={addLike} className="lg:tooltip lg:tooltip-right lg:z-40" data-tip="Like this post"><AiFillLike /></button>
                        {post.likes ? post.likes : 0}
                    </div>
                    <div className="flex gap-2">
                        <Link to={`/posts/${post.id}`} className="lg:tooltip lg:tooltip-right lg:z-30" data-tip="View replies">
